...
REMOTE_BREWFILE="https://raw.githubusercontent.com/aquacode/Brewfile/HEAD/Brewfile"
...
show_intro () {
  echo -e "\n${QUESTION_COLOR}🍺 aquacode/Brewfile - Installation Script${RESET}"
...
echo -e "\033[0;33m\x1b[2mThank you for using aquacode/Brewfile${RESET}"
